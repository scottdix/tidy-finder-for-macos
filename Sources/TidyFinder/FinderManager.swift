...
class FinderManager {
    ...
    enum FinderOption: String, CaseIterable {
    ...
    func setDefaultViewStyle(to style: ViewStyle) throws {
    ...
    func setGlobalOption(_ option: FinderOption, to value: Bool) throws {
    ...
    func resetAllExistingViews() throws {
    ...
    func getCurrentViewStyle() -> ViewStyle? {
        do {
    ...
    func getOptionValue(_ option: FinderOption) -> Bool {
        do {
